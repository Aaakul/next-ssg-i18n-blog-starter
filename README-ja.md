...
- **優れたユーザー体験**: [Lighthouse スコアがほぼ満点。](https://pagespeed.web.dev/analysis/https-next-ssg-i18n-blog-starter-pages-dev-en-blog-sample-intro/mzfi3x5wu6?form_factor=mobile)
...
```ts
title: string
date: string // ISO 8601 形式、例えば：'2025-01-01T08:35:00Z'
