---
title: 'Introducing Next SSG i18n Blog Starter v0.2'
...
- **Post Layouts**  
  ...
  - `PostBanner`: Full-width banner image at the top, no sidebar TOC. [View sample page](/en/blog/sample/MDX-sample).
