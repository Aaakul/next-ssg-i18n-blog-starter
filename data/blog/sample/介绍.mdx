...
- [**图片加载优化**](/zh/blog/sample/MDX%E7%A4%BA%E4%BE%8B#%E5%86%85%E7%BD%AE%E5%9B%BE%E7%89%87%E7%BB%84%E4%BB%B6): 使用SVG占位符提升图片加载期间的用户体验。自动为本地PNG和JPG图片创建WebP副本，优化现代浏览器中的图片加载。本地 PNG 和 JPG 格式的文章 Banner 图片无需手动设置 WebP 副本的路径。
- **现代化的Markdown写作**:
